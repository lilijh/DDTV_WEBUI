...
export function getRecordingPath() {
  return instance.get<Response<string>>('config/get_recording_path')
}

export function setFileNameAndPath(data: { path_and_format: string; check?: string }) {
  return instance.post<Response<string>>('config/set_default_file_path_name_format', data)
}

export function getFileNameAndPath() {
  return instance.get<Response<string>>('config/get_default_file_path_name_format')
}
export function getHLSWaitingTime() {
  return instance.get<Response<any>>('config/get_hls_waiting_time')
}

export function setHLSWaitingTime(data: { waiting_time: number }) {
